...
HTML,
            ...
            'sample' => [
                'count' => '1',
                'days'  => '2',
                'items' => 'HR-2026-0004  AST-0011 Site transformer — Northfield Electrical — due back 12 Aug 2026',
            ],
        ],
...
HTML,
            ...
            'sample' => [
                'count' => '1',
                'items' => 'HR-2026-0002  AST-0006 Cement mixer — J Bloggs — 3 days overdue',
            ],
        ],
...
HTML,
            'fields' => [
                ...
                'asset_tag'        => 'The asset tag',
                'asset_name'       => 'The asset name',
                'reference'        => 'The hire reference, e.g. HR-2026-0004',
