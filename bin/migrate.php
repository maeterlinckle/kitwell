 ...
 *
 *   php bin/migrate.php            run everything that has not been applied
...
echo "Next: create the first administrator with `php bin/create-admin.php`,\n";
echo "or load the demo data with `php bin/seed.php`.\n";
